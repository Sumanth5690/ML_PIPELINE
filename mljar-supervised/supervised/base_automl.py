...
"""
    ...
    def _md_to_html(self, md_fname, page_type, dir_path, me=None):
        ...
        if page_type == f"automl-report-main-{self._id}":
            # Add CSS to hide MLJAR logo
            beginning += """<style>
img[src*="github.com/mljar"],
img[src*="mljar"],
a[href*="mljar.com"] img,
a[href*="github.com/mljar"] img,
img[style*="height:128px"],
img[src="https://raw.githubusercontent.com/mljar/visual-identity/main/media/mljar_AutomatedML.png"] {
...
"""
            beginning += """<h1 style="text-align:center; margin: 0.67em 0;">Intelligent Regression Analytics</h1>\n\n"""
...
<body>
    <div class="ira-automl-report-{self._id}">
    {body}
    <div>
</body>
</html>
